...
class PhysicsObject : public Object
{
  public:
     ...
     */
    PhysicsObject(SDL_Rect body, int flags, std::weak_ptr<Texture_base> texture = NoTexture);
     ...
     */
    [[nodiscard]] virtual SDL_FPoint getVelocity()
    {
        return nextVelocity;
    };
     ...
     */
    [[nodiscard]] const SDL_Rect* getBody() const override
    {
        return &interBody;
    };
