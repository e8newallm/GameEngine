...
{
    device.gpu = SDL_CreateGPUDevice(flags, false, nullptr);
};
...
std::shared_ptr<Pipeline> Pipeline::createPipeline(const Window& win, const std::string& vertShader = "default",
                                                   const std::string& fragShader = "default")
{
