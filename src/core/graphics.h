...
{
  public:
    static void GPUDeviceInit(SDL_GPUShaderFormat flags = SDL_GPU_SHADERFORMAT_SPIRV | SDL_GPU_SHADERFORMAT_DXIL |
...
/**
 * \brief A class for wrapping SDL_GPUSampler for use with the DataStore in the class. Also contains functions for
 * creating and storing all created SDL samplers.
 *
 */
class Sampler : public DataStore<Sampler, Sampler>
{
  public:
     ...
     */
    explicit Sampler(SDL_GPUSampler* sampler)
    {
...
/**
 * \brief A class for wrapping SDL_GPUGraphicsPipeline for use with the DataStore in the class. Also contains functions
 * for creating and storing all created SDL Pipelines.
 *
 */
class Pipeline : public DataStore<Pipeline, Pipeline>
{
  public:
     ...
     */
    explicit Pipeline(SDL_GPUGraphicsPipeline* pipeline)
    {
     ...
     */
    static std::shared_ptr<Pipeline> createPipeline(const Window& win, const std::string& vertShader,
